...
function PluginMarketplaceSettingsTab({ t }) {
	...
	const saveGithubToken = async () => {
		...
		try {
			...
			setMessage({
				kind: "error",
				text: error instanceof Error ? error.message : t("githubTokenSaveFailed")
			});
		} finally {
			setAction(null);
		}
