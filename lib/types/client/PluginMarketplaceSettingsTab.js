...
export function PluginMarketplaceSettingsTab({ t }) {
    ...
    const updateSelf = async () => {
        ...
        setRestartAvailable(false);
        try {
            const result = await api('/self-update', { method: 'POST', body: JSON.stringify({}) });
